(function () {
  ...
  var EN = {
    ...
    burnMethodTitle: 'Schedule calculation', burnMethodHeading: 'One transparent daily rule.', burnMethodBody: 'At 273,972 MA per day, 365 daily burns total 99,999,780 MA, leaving 220 MA from the planned reserve.',
    burnRemainderLabel: 'Remainder requiring policy', burnRemainderNote: 'Must be explicitly handled in the final rule.', burnSemanticsTitle: 'Burn semantics must be fixed before launch.', burnSemanticsBody: 'Sending to a dead address generally makes tokens inaccessible but may not reduce ERC-20 totalSupply. The final contract, destination and definition of “burned” will be published before counting begins.',
    ...
    meaningCalculationTitle: 'Transparent calculation', meaningAllocationHeading: 'A 30 million MA target allocation.', meaningCalculationBodyCorrected: '30,000,000 MA equals 3% of the planned initial 1,000,000,000 MA launch supply. Its reference value will be 30,000,000 × a verified live MA price.', meaningAllocationLabel: 'Planned token allocation', meaningSupplyShareLabel: 'Share of planned initial supply', meaningSupplyShareNote: 'Based on 1,000,000,000 MA initial supply', meaningReferenceValueLabel: 'Verified reference value', meaningPricePending: 'Live price: awaiting verified market data', meaningAfterBurnNote: 'If total supply later decreases through a true burn, 30 million MA would represent a larger percentage of then-current supply. This page therefore uses the initial launch supply as its fixed reference.',
